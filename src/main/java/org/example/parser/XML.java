...
public class XML {
    ...
    public static void parseXML(String xmlInputFile, String xmlOutFile) {
        ...
        try {
            ...
            if (studentList.size() > 0) {
                Average(studentList);
                createFile(studentList, xmlOutFile);
            }
    ...
    private static void Average(ArrayList<Student> studentArrayList) {
    ...
    private static void createFile(ArrayList<Student> studentArrayList, String xmlOutFile) {
        try {
            DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();
            ...
            System.out.println("Created output file: " + xmlOutFile);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
